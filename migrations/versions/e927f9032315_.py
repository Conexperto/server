...
Revision ID: e927f9032315
Revises: 6a9754d3587b
Create Date: 2021-08-20 00:00:34.179395
...
revision = "e927f9032315"
down_revision = "6a9754d3587b"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        "association_user_to_speciality",
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.Column("left_id", sa.Integer(), nullable=False),
        sa.Column("right_id", sa.Integer(), nullable=False),
