...
def create_api(env):
    api = Flask(
        __name__, root_path=abspath(join(__package__, "../")), static_folder="/static"
    )
    ...
    from src.blueprints.admin import (
        auth_admin,
        admin,
        user_admin,
        expert_admin,
    ...
    from src.blueprints import auth, user, expert, speciality, method, search
